...
## Power in Statistics 
- $P(Rejecting  \hspace{0.2cm}  H_0|\~ H_0)$ the probability of rejecting null hypothesis, the large power, the lower overlap beween samples (control and variant group)
